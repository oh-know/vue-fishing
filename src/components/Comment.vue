...
export default {
  ...
  mounted() {
    // document.querySelector('.jInput').addEventListener('touchstart', function() {
    //   document.querySelector('.area').focus()
    // })
    // document.querySelector('.jInput').addEventListener('touchend', function() {
    //   document.querySelector('.area').focus()
    // })
  ...
  methods: {
    ...
    getData() {
      ...
      // this.city = this.$refs.place.innerHTML
      let param = new URLSearchParams()
      param.append('address', this.city)
      ...
      param.append('remove', this.remove)
      console.log(objid, cateid)
