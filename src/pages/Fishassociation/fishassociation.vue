<template lang="html">
  <div class="fishassociation">
    ...
    <div class="group">
      ...
      <div class="spread">
        <div class="spread_item" v-for="item in child" @click.stop.prevent="replace(item.id 
      ...
      <div class="server">
        <div class="fish"v-for="item in server">
          <div class="padd">
            ...
            <div class="fishname">{{item.name 

}}</div>
            <div class="tel" @click="callphone(item.tel 

)"> <img src="../../../static/images/telephone.jpg" alt="" class="telpic">{{item.tel 
...
export default {
  ...
  mounted() {
    ...
    this.axios.post('http://yulejia.pnnnc.com/api/diaoxie')
      .then(res => {
